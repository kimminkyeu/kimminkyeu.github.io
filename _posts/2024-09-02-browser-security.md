...
author: "김민규"
categories: "Kernel360 기술세미나"
banner:
  image: "/assets/images/post/2024-09-02-browser-security/1.png"
  background: "#000"
  height: "100vh"
  min_height: "38vh"
...
![image 1](/assets/images/post/2024-09-02-browser-security/1.png)
...
![image 2](/assets/images/post/2024-09-02-browser-security/2.png)
...
![image 3](/assets/images/post/2024-09-02-browser-security/3.png)
...
![image 4](/assets/images/post/2024-09-02-browser-security/4.png)
...
![image 5](/assets/images/post/2024-09-02-browser-security/5.png)

이는 서버가 허용한 교차 출처 목록이 없다는 의미입니다.

브라우저가 `OPTION` 으로 보낸 `Preflight` 요청으로 인해 발생한 CORS 정책 위반 메시지입니다. 

![image 6](/assets/images/post/2024-09-02-browser-security/6.png)

브라우저가 본 요청에 앞서 보내는 OPTION 요청이 preflight 요청입니다.

![image 7](/assets/images/post/2024-09-02-browser-security/7.png)
![image 8](/assets/images/post/2024-09-02-browser-security/8.png)

만약 출처도 다르고(Origin) 교차 출처 허용(CORS)도 없다면, `fetch` 요청시 정책 위반 에러가 발생합니다.

![image 9](/assets/images/post/2024-09-02-browser-security/9.png)

프론트엔드 앱 서버와 API 서버 URL이 다른 경우, 해결 방법은 아래와 같습니다.

- 방법 1. 허용할 출처를 Preflight 응답에 서버가 명시한다.
    ![image 10](/assets/images/post/2024-09-02-browser-security/10.png)

- 방법 2. 프론트 / API의 Origin를 동일하게 맞춘다.
    ![image 11](/assets/images/post/2024-09-02-browser-security/11.png)

- 방법 3. 브라우저 보안 정책을 회피한다.
    - Background Service Worker 를 이용한다. ( 크롬 확장 프로그램 개발 )
        ![image 12](/assets/images/post/2024-09-02-browser-security/12.png)
...
![image 13](/assets/images/post/2024-09-02-browser-security/13.png)
